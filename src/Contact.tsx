...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.success("Message sent! Our team will respond within 1 hour during business hours.");
              ...
              <Card className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@signova.ai" className="text-indigo-600 hover:underline">
                      support@signova.ai
                    </a>
                  </div>
                </div>
      ...
      <div className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <Card className="p-6">
              <h3 className="font-bold mb-2">Do you offer demos?</h3>
              <p className="text-gray-600 text-sm">
                Yes! Schedule a personalized demo with our team to see how Signova can transform 
